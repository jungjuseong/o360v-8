...
public class ProjectOwner implements Serializable {
    ...
    public void setProjects(Set<Project> projects) {
        if (this.projects != null) {
            this.projects.forEach(i -> i.setProjectOwner(null));
        }
        if (projects != null) {
            projects.forEach(i -> i.setProjectOwner(this));
        }
        this.projects = projects;
    }

    public ProjectOwner projects(Set<Project> projects) {
        this.setProjects(projects);
        return this;
    }

    public ProjectOwner addProject(Project project) {
        this.projects.add(project);
        project.setProjectOwner(this);
        return this;
    }

    public ProjectOwner removeProject(Project project) {
    ...
    public boolean equals(Object o) {
        ...
        return id != null && id.equals(((ProjectOwner) o).id);
    }
