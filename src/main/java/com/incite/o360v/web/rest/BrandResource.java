...
/**
 * REST controller for managing {@link com.incite.o360v.domain.Brand}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BrandResource {
     ...
     */
    @GetMapping("/brands")
    public List<Brand> getAllBrands(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
    ...
    public ResponseEntity<Brand> getBrand(@PathVariable Long id) {
        ...
        Optional<Brand> brand = brandRepository.findOneWithEagerRelationships(id);
