...
const requireRestSample: RestProject = {
  ...
  fiscalYear: sampleWithRequiredData.fiscalYear?.format(DATE_FORMAT),
  createdDate: sampleWithRequiredData.createdDate?.format(DATE_FORMAT),
  startDate: sampleWithRequiredData.startDate?.format(DATE_FORMAT),
  deploymentDate: sampleWithRequiredData.deploymentDate?.format(DATE_FORMAT),
  endDate: sampleWithRequiredData.endDate?.format(DATE_FORMAT),
  jiraUpdate: sampleWithRequiredData.jiraUpdate?.format(DATE_FORMAT),
};
