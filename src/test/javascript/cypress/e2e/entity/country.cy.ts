...
describe('Country e2e test', () => {
  ...
  const countrySample = { name: 'submarine frantically whereas' };
  ...
  describe('new Country page', () => {
    ...
    it('should create an instance of Country', () => {
      cy.get(`[data-cy="name"]`).type('adventurously however');
      cy.get(`[data-cy="name"]`).should('have.value', 'adventurously however');
